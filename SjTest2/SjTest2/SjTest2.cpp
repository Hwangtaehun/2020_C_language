...
// SjTest2.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CSjTest2App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSjTest2App::OnAppAbout)
...
CSjTest2App::CSjTest2App() noexcept
{
	...
	SetAppID(_T("SjTest2.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CSjTest2App 개체입니다.
...
BOOL CSjTest2App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSjTest2Doc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CSjTest2View));
	if (!pDocTemplate)
		return FALSE;

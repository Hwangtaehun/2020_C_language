...
// SjOdbc1Set.h: CSjOdbc1Set 클래스의 인터페이스
//
...
class CSjOdbc1Set : public CRecordset
{
public:
	CSjOdbc1Set(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CSjOdbc1Set)
...
// 버전 3.5 이상을 사용해야 합니다).
	...
	long	m_nKor;	//국어점수 Long
	long	m_nMat;	//수학점수 Long
	long	m_nEng;	//영어점수 Long
	long	m_nTotal;	//총점 Long
	double	m_dAverage;	//평균 Double
	long	m_nRank;	//순위 Long
